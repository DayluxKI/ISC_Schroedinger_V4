...
class QuantumAudioSynthesizer:
    """
    Echtzeitaudio-Synthese basierend auf GPU-Zustandswerten.
    ...
    def __init__(self, sample_rate: int = 44100, chunk_size: int = 2048):
        ...
        print("✅ QuantumAudioSynthesizer initialized (44.1kHz, 2048 chunk)")
    ...
    def _synthesis_loop(self):
        ...
        while self.is_running:
            ...
            # Play (blocking, will take ~46ms for 2048 samples @ 44.1kHz)
            if audio_chunk is not None:
                try:
                    self.current_audio = sa.play_buffer(
                        audio_chunk,
                        num_channels=1,
                        bytes_per_sample=2,
    ...
    def _generate_audio_chunk(self) -> Optional[np.ndarray]:
    ...
    def _poll_gpu_state(self):
        ...
        while self.is_running:
            try:
                ...
                print(f"⚠️  Error polling GPU state: {e}")
